...
const LSBattle = (() => {
  ...
  // 攻擊力刻意非線性遞增
  const MASTERS = [
    { id: 'wangyirong', name: '王懿榮', avatar: '🦴', title: '甲骨文發現者', atk: 6, unlock: 0, level: null, taunt: '一片龍骨，讓我看見三千年前的文字。你呢？' },
    { id: 'lisi', name: '李斯', avatar: '📜', title: '小篆定於一尊', atk: 9, unlock: 8, level: null, taunt: '書同文字！六國異形，皆廢於我手。' },
    { id: 'guifu', name: '桂馥', avatar: '🏮', title: '說文四大家・義證', atk: 12, unlock: 18, level: null, taunt: '《說文義證》五十卷，字字有據。' },
    { id: 'wangjun', name: '王筠', avatar: '🖋️', title: '說文四大家・句讀', atk: 14, unlock: 30, level: null, taunt: '我為初學者解說文，也考你這初學者。' },
    { id: 'zhujunsheng', name: '朱駿聲', avatar: '🔔', title: '說文四大家・通訓定聲', atk: 17, unlock: 45, level: '進階', taunt: '轉注、假借，盡在我《通訓定聲》彀中。' },
    { id: 'duanyucai', name: '段玉裁', avatar: '📚', title: '說文四大家・段注', atk: 20, unlock: 65, level: '進階', taunt: '《說文解字注》三十年而成，豈懼你半日之功？' },
    { id: 'xushen', name: '許慎', avatar: '⚖️', title: '五經無雙・說文解字', atk: 24, unlock: 90, level: '進階', taunt: '六書之名，自我而定。敢在關公面前耍大刀？' },
    { id: 'cangjie', name: '倉頡', avatar: '👁️', title: '四目造字・天雨粟鬼夜哭', atk: 30, unlock: 120, level: '挑戰', taunt: '我造字時，天雨粟、鬼夜哭。你答錯時，也會想哭。' }
  ];
...
<div class="battle-head">
  ...
  <div class="battle-avatar">${st.m.avatar}</div>
