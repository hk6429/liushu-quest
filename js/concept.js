...
<div class="card">
  ...
  <p class="muted">「六書」一詞最早見於《周禮》，東漢許慎在《說文解字．敘》為六書一一下了定義並舉出例字。把前四書稱為構形方式、後兩書稱為用字關係，是後世常見的「四體二用」教學整理，並非許慎原文，學者也有不同解釋。本站採現代常見教學次序介紹：象形、指事、會意、形聲、轉注、假借；這是本站教學編排，不是《說文解字．敘》的原序，也不是漢字依序誕生的時間表。《說文解字．敘》原列次序為指事、象形、形聲、會意、轉注、假借。</p>
</div>
...
<div class="card">
  ...
  <b>② 借義占用本字，本義另造字</b>：例如「其」的字形本象畚箕，後借作代詞，本義另造「箕」；「莫」的構形會日暮之意，後借為否定用法，本義另造「暮」。</p>
  <p class="muted">「有借有還／有借不還」是便於入門的記憶說法，不是借用行為真的發生。部分本義另造字的例子能幫助理解形聲字的形成，但不是所有形聲字的單一起源或固定時間順序。</p>
