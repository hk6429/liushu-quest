...
const [index, rights, evidence, concept, story, quiz, app, flashcard, battle, notices, provenance, css] = await Promise.all([
...
console.log(`✅ copyright tests 通過：學生前台無外部原文與資料連結；${imagePaths.length} 張圖來源、AI、第三方與下架護欄成立`);
